package com.zzh.springbootwebinterceptor.config;
...
public class LogAspect {
     ...
     * 最后两个..:所有类型的参数
     */
    @Pointcut("execution(public * com.zzh.springbootwebinterceptor.controller..*.*(..))")
    public void webLog(){
    ...
    public void aspectAfterReturning(Object ret) throws Throwable {
